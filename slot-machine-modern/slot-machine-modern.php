...
<link rel="stylesheet" type="text/css" href="css/slot-machine-modern.css" />
<script type="text/javascript" src="js/slot-machine-modern.js"></script>
<div class="container slots">
	...
	<div class="row stage-row">
		<div class="col-sm-12 stage-box">
			<div class="stage">
				<div class="slots-result"><div class="slots-con"><div class="slot-con"><img src="<?php echo $zip_img_src; ?>" alt="BLANK" class="slot-image slot-number0 zero" /></div><div class="slot-con"><img alt="BLANK" src="<?php echo $zip_img_src; ?>" class="slot-image slot-number1 zero" /></div><div class="slot-con"><img alt="BLANK" src="<?php echo $zip_img_src; ?>" class="slot-image slot-number2 zero" /></div></div></div>
