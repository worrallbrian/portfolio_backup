function drawCard(card_no, to_hide, is_house, is_hold) {
	var v = "",
	card_isred = false,
	card_decor = "",
	card_text = "",
	card_ascii = "",
	icon_innards = (((is_hold != null) && (parseInt(is_hold) == 1)) ? "H" : "D"),
	...
	if ((this_card != null) && (this_card != "")) {
		...
		v = "<div class=\"img-box\">";
		v += "<div class=\"slot-keep\">";
		v += "<button type=\"button\" class=\"btn btn-warning slot-keep-button\"><span class=\"slot-keep-icon\">" + icon_innards + "</span></button>";
		v += "</div>";
...
function drawVR() {
	...
	row += "<div class=\"game-title\">Video Poker</div>";
